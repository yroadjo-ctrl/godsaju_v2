...
export default function OhaengSipsinSection({ stats }: Props) {
  ...
  return (
    <section>
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
        ...
        {' '}{stats.dayElementLabel} · 원국 {stats.totalCharSlots}글자(천간·지지 각 1) 기준
      </p>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">
        ※ 발달(20%↑)·적정(10~20%)·부족(10%↓). 지장간·합화·조후 보정은 미포함(추후 단계).
      </p>
    </section>
  )
}
