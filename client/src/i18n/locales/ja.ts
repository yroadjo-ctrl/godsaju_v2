const ja: Record<string, string> = {
  ...
  'form.calendar.lunarLeap': '閏月(旧暦)',
  'form.lunarLeapHint': 'この年の閏月は{month}月です。閏月生まれは「閏月(旧暦)」を選んでください。',
  ...
  'form.time': '時間',
  'form.shichenHelpLink': '(十二支で時間を入力)',
  ...
  'form.shichenHelpAria': '十二支で時間を入力',
  'form.shichenHelpTitle': '十二支時間表',
  'form.shichenHelpIntro': '干支だけ分かる場合は下表を参考にするか、干支をクリックして開始時刻+1時間を自動入力できます。正確な出生時刻が分かる場合は時間入力欄に直接入力してください。',
  'form.shichen.colBranch': '干支',
  'form.shichen.colTime': '時間',
  'form.shichen.legend.zi': '23:30(前日) ~ 01:30',
  'form.shichen.hint.ziRange': '23:30(前日)~01:30',
  'form.shichen.hint.ziBirthdayNote': '(誕生日が変わらない時刻で入力)',
