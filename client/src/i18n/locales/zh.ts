const zh: Record<string, string> = {
  ...
  'form.calendar.lunarLeap': '闰月(阴历)',
  'form.lunarLeapHint': '该年闰月为{month}月。闰月出生请选择「闰月(阴历)」。',
  ...
  'form.shichenHelpAria': '按十二时辰输入时间',
  'form.shichenHelpTitle': '十二时辰时间表',
  'form.shichenHelpIntro': '若只知道时辰名称，请参考下表或点击干支以自动填入起始时间+1小时。若知道准确出生时间，请直接在时间输入栏中输入。',
  ...
  'form.shichen.hint.ziBirthdayNote': '(生日不变的时间已输入)',
