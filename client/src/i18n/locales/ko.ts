...
const ko: Record<string, string> = {
  ...
  'form.calendar.lunarLeap': '윤달(음력)',
  'form.lunarLeapHint': '이 해의 윤달은 {month}월입니다. 윤달 생일은 「윤달(음력)」을 선택하세요.',
  ...
  'timeAdjust.localSolarInput': '입력 벽시계 : {datetime}',
  ...
  'timeAdjust.appliedTime': '→ 사주 적용 시각 : {datetime}',
