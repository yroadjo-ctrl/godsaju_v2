...
const ko: Record<string, string> = {
  ...
  'form.time': '시간',
  'form.shichenHelpLink': '(12간지로 시간 보기)',
  ...
  'form.shichenHelpAria': '12간지 시간표 보기',
  'form.shichenHelpTitle': '12간지 시간표',
  'form.shichenHelpIntro': '간지로만 시간을 아실 때는 아래 구간을 참고하여 시·분을 직접 선택해 주세요. 정확한 출생 시각이 있으면 그대로 입력하시면 됩니다.',
