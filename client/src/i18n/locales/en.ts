const en: Record<string, string> = {
  ...
  'timeAdjust.localSolarInput': 'Entered wall clock {time}',
  ...
  'timeAdjust.appliedTime': '→ Applied time for Saju {time}',
  'timeAdjust.appliedDateTime': '→ Applied for Saju {date} {time}',
