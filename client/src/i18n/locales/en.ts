const en: Record<string, string> = {
  ...
  'form.calendar.lunarLeap': 'Leap lunar',
  'form.lunarLeapHint': 'Leap month this year: month {month}. Use “Leap lunar” for birthdays in the leap month.',
  ...
  'form.time': 'Time',
  'form.shichenHelpLink': '(Enter time by 12 branches)',
  ...
  'form.shichenHelpAria': 'Enter time by 12 branches',
  'form.shichenHelpTitle': '12-Branch Time Table',
  'form.shichenHelpIntro': 'If you only know the traditional branch name, use the ranges below or click a branch to fill in start time + 1 hour. If you know the exact birth time, enter it directly in the time fields.',
  ...
  'timeAdjust.kstTitle': 'Calculation basis: KST wall clock',
  'timeAdjust.kstNoCorrection': 'Born in Korea — no longitude correction; entered time is used as-is.',
  'timeAdjust.kstHistoricalNote': 'Historical timezone period → normalized {input} → {adjusted} (KST)',
  'timeAdjust.localSolarTitle': 'Calculation basis: local apparent solar time',
  'timeAdjust.localSolarInput': 'Entered wall clock: {datetime}',
  'timeAdjust.longitudeCorrection': 'Longitude correction (birth lon − standard meridian)×4 min: {value}',
  'timeAdjust.equationOfTime': 'Equation of time: {value}',
  'timeAdjust.totalCorrection': 'Total: {value}',
  'timeAdjust.appliedTime': '→ Applied time for Saju: {datetime}',
  'timeAdjust.localSolarFootnote': 'DST is already reflected in the entered wall clock.',
