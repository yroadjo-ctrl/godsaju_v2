...
export const YUN_METHOD_NOTES = {
  ...
  daewoon:
    '※ 월주(12節) 순·역행 · 절기(lunar+KST) · 3일=1년 · 교체 = ◆시작 행.',
  ...
  sounCount:
    '※ 소운 칸 수 = 1운 startDate 연도 − 출생 연도. 칸 나이 = 12/31 만나이.',

  soun:
    '※ 小運: 时柱(月柱) 기준 · 阳男阴女順·阴男阳女逆 · 간지 교체 = 입춘.',
...
export const YUN_SEWOON_UI_NOTES = [
  '※ 칸 나이 = 12/31 만나이(대운과 동일). 流年 = 입춘 기준 · 입춘 전 = 전년 流年(◆절기 행).',
  '※ 용신·伏吟/反吟 = 原局·합화 기준.',
] as const
